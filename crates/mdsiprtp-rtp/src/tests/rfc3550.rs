...
mod sequence_numbers {
    ...
    fn test_sequence_increment() {
        ...
        assert_eq!(packet2.sequence_number, packet1.sequence_number.wrapping_add(1));
    }
...
mod ssrc_handling {
    ...
    fn test_ssrc_collision_detection() {
        ...
        let data = [
            ...
            0x00, 0x00, 0x30, 0x39, // SSRC 12345 (collision!)
            0xaa, 0xbb,
        ];
