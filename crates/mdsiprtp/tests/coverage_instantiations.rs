use mdsiprtp::sdp::parser::{Direction, SdpParseError, SessionDescription};
use mdsiprtp::sip::{Method, SipMessage, SipRequest, SipResponse};
use mdsiprtp::transaction::{ManagerAction, Timer, TransactionManager};
...
fn extract_handle(actions: &[ManagerAction]) -> mdsiprtp::transaction::TransactionHandle {
    actions
        .iter()
        .find_map(|action| {
